...
public enum ResultCode implements IErrorCode {
        ...
        CONNECT_NOT_EXIST("90003", "登录方式不存在！"),
        ELASTICSEARCH_INDEX_INIT_ERROR("90004", "索引初始化失败！"),
        PURCHASE_ORDER_DEADLINE_ERROR("90005", "供求单，已超过报名截止时间"),
        USER_ADD_ERROR("90006", "用户添加失败"),
        INDEX_BUILDING("90007", "索引正在生成");

...
import org.duku.mall.frameworks.starter.cache.toolkit.CacheUtil;
import org.duku.mall.frameworks.starter.cache.toolkit.FastJson2Util;
...
public class StringRedisTemplateProxy implements DistributedCache {
    ...
    public StringRedisTemplateProxy(StringRedisTemplate stringRedisTemplate, org.duku.mall.frameworks.starter.cache.config.RedisDistributedProperties redisDistributedProperties, RedissonClient redissonClient, StringRedisTemplate stringRedisTemplate1, RedisDistributedProperties redisProperties, RedissonClient redissonClient1) {

...
import org.duku.mall.framework.starter.common.modules.order.order.entity.enums.*;
...
public class OrderSearchParams extends PageVO {
    ...
    public <T> QueryWrapper<T> queryWrapper() {
        ...
        if (currentUser != null) {
            ...
            //按买家查询
            wrapper.eq(CharSequenceUtil.equals(currentUser.getRole().name(), UserEnums.MEMBER.name()) && memberId == null, "o.member_id", currentUser.getUserId());

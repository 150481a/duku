package org.duku.mall.framework.starter.common.common.utils;
...
public class ResultUtil<T> {
     ...
     * @return 消息
     */
    public static <T> ResultMessage<T> error(String code, String msg) {
     ...
     * @return 消息
     */
    public ResultMessage<T> setErrorMsg(String code, String msg) {
        this.resultMessage.setSuccess(false);

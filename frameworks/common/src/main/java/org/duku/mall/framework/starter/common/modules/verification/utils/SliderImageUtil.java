...
//        ImageUtil.addWatermark(originalImage, watermark);
        ...
        pictureMap.put("slidingImage", "data:image/png;base64," + Base64.encodeToString(newImagery));
        pictureMap.put("backImage", "data:image/png;base64," + Base64.encodeToString(oriImageByte));
//       x轴

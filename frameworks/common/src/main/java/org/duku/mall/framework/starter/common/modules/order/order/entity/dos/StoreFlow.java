...
import org.duku.mall.framework.starter.common.modules.order.order.entity.enums.FlowTypeEnum;
import org.duku.mall.framework.starter.common.modules.order.order.entity.enums.OrderPromotionTypeEnum;
import org.duku.mall.framework.starter.common.modules.order.order.entity.enums.ProfitSharingStatusEnum;
...
public class StoreFlow extends BaseIdEntity {
    ...
    /**
     * @see org.duku.mall.framework.starter.common.modules.payment.entity.enums.PaymentMethodEnum
     */
    ...
    public StoreFlow(Order order, OrderItem item, FlowTypeEnum flowTypeEnum) {
        ...
        this.setSn(SnowflakeIdUtil.createStr("SF"));

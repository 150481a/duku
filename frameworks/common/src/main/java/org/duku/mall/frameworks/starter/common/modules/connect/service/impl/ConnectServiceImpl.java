package org.duku.mall.frameworks.starter.common.modules.connect.service.impl;
...
import org.duku.mall.frameworks.starter.common.common.utils.UuidUtils;
import org.duku.mall.frameworks.starter.common.modules.connect.entity.Connect;
...
import org.duku.mall.frameworks.starter.common.modules.connect.entity.dto.MemberConnectLoginMessage;
import org.duku.mall.frameworks.starter.common.modules.connect.entity.dto.WechatMPLoginParams;
import org.duku.mall.frameworks.starter.common.modules.connect.entity.enums.ConnectEnum;
import org.duku.mall.frameworks.starter.common.modules.connect.entity.enums.SourceEnum;
import org.duku.mall.frameworks.starter.common.modules.connect.mapper.ConnectMapper;
import org.duku.mall.frameworks.starter.common.modules.connect.service.ConnectService;
import org.duku.mall.frameworks.starter.common.modules.member.entity.dto.ConnectQueryDTO;
import org.duku.mall.frameworks.starter.common.modules.system.service.SettingService;
...
public class ConnectServiceImpl  extends ServiceImpl<ConnectMapper, Connect> implements ConnectService  {
    ...
    public void bind(String unionId, String type) {
        UserInfoDTO authUser = Objects.requireNonNull(UserContext.getCurrentUser());
        Connect connect = new Connect(authUser.getUserId(), unionId, type);
        this.save(connect);
    ...
    public void unbind(String type) {
        ...
        queryWrapper.eq(Connect::getUserId, UserContext.getCurrentUser().getUserId());

...
package org.duku.mall.framework.starter.log.core;
...
import org.duku.mall.framework.starter.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(org.duku.mall.framework.starter.log.annotation.ILog) || @annotation(org.duku.mall.framework.starter.log.annotation.ILog)")
